...
<head>
	<title> אל .די אמפורטר | יבוא ושיווק ריהוט משלים</title>
	<meta charset="UTF-8">
...
-->
	...
	<link rel="preload" href="<?php echo $css; ?>plyr.min.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
	<!-- END NICE VIDEO  -->

	<link rel="preload" href="<?php echo $css; ?>/util.css" as="style" onload="this.onload=null;this.rel='stylesheet'">

	<link rel="preload" href="<?php echo $css; ?>/main-v1.css" as="style" onload="this.onload=null;this.rel='stylesheet'">
	<!--===============================================================================================-->
</head>
