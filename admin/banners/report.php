                        ...
                        <div class="modal-content">
                            ...
                            <form action="main.php?dir=banners&page=add" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label for="Company-2" class="block"> الزر </label>
                                        <input required id="Company-2" name="button_text" type="text" class="form-control required">
                                    </div>
                                    <div class="form-group">
                                        <label for="Company-2" class="block"> الرابط </label>
                                        <input required id="Company-2" name="button_url" type="text" class="form-control required">
                                    </div>
                                    <div class="form-group">
