                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="my_table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $connect->prepare("SELECT * FROM about_us ORDER BY id DESC");
                                    $stmt->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 80px; height:80px;" src="about_us/images/<?php echo $cat['image']; ?>" alt="">
                                            </td>
                                        ...
                                        <div class="modal fade" id="edit-Modal_<?php echo $cat['id']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="main.php?dir=about_us&page=edit" enctype="multipart/form-data">
