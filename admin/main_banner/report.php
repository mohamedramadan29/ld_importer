...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark"> البانر الرئيسي  </h1>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-left">
                    <li class="breadcrumb-item"><a href="main.php?dir=dashboard&page=dashboard">الرئيسية</a></li>
                    <li class="breadcrumb-item active"> البانر الرئيسي </li>
                </ol>
            </div>
            <!-- /.col -->
        </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="my_table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $stmt = $connect->prepare("SELECT * FROM main_banner ORDER BY id DESC");
                                    $stmt->execute();
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width: 80px; height:80px;" src="main_banner/images/<?php echo $cat['image']; ?>" alt="">
                                            </td>
                                        ...
                                        <div class="modal fade" id="edit-Modal_<?php echo $cat['id']; ?>" tabindex="-1" role="dialog">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" action="main.php?dir=main_banner&page=edit" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="Company-2" class="block"> الزر </label>
                                                                <input required id="Company-2" name="button_text" type="text" class="form-control required" value="<?php echo  $cat['button_text'] ?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="Company-2" class="block"> الرابط </label>
                                                                <input required id="Company-2" name="button_url" type="text" class="form-control required" value="<?php echo  $cat['button_url'] ?>">
                                                            </div>
                                                            <div class="form-group">
