			...
			<div class="dis-none panel-search w-full p-t-10 p-b-15">
				<form action="" method="post">
					<div class="bor8 dis-flex p-l-15 justify-content-between">
						<input value="<?php if (isset($_REQUEST['search_product'])) echo $_REQUEST['search_product']; ?>" class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search_product" placeholder="מה לחפש לך ?">
